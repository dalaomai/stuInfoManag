...
var evt;
var changeIndex;
var titleList = new Array('Name','TeacherId','Sex','Passwd');
var rows = new Array()

//初始化bootstrap-table的内容
function InitMainTable () {
    //记录页面bootstrap-table全局变量$table，方便应用
    var queryUrl = '/teacher/data?rnd=' + Math.random()
    ...
    $('#addData').click(function(){
        $table.bootstrapTable('prepend',{0: undefined,new:true, 'Name':'','TeacherId':'','Sex':'','Passwd':''});
        initTableEdit();
    });
};
